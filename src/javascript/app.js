...
window.vit = (function() {
  ...
  var load = function(options) {
    ...
    var protocol = 'https',
      googleMapsUrl = protocol + '://maps.googleapis.com/maps/api/js?libraries=places,geometry&language=iw&callback=' + '_VIT_GOOGLE_MAPS_INIT_CALLBACK',
      googleWebFontsUrl = protocol + '://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js';
    ...
    var WebFontConfig = {
      google: {
        families: ['Roboto:400,500,700:latin']
      }
    };
